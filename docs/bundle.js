...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst skynode_1 = __webpack_require__(/*! @hanul/skynode */ \"./node_modules/@hanul/skynode/lib/index.js\");\nconst Layout_1 = __importDefault(__webpack_require__(/*! ./Layout */ \"./src/view/Layout.ts\"));\nclass Home {\n    constructor() {\n        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(\".home-view\", (0, skynode_1.el)(\".video-container\", (0, skynode_1.el)(\"video\", { \"autoplay\": \"\", \"loop\": \"\" }, (0, skynode_1.el)(\"source\", { src: \"/video/home.mp4\", type: \"video/mp4\" })))).appendTo(skynode_1.BodyNode));\n    }\n    changeParams(params, uri) { }\n    close() {\n        this.container.delete();\n    }\n}\nexports[\"default\"] = Home;\n\n\n//# sourceURL=webpack:///./src/view/Home.ts?");
