...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst skynode_1 = __webpack_require__(/*! @hanul/skynode */ \"./node_modules/@hanul/skynode/lib/index.js\");\nconst Layout_1 = __importDefault(__webpack_require__(/*! ./Layout */ \"./src/view/Layout.ts\"));\nclass Home {\n    constructor() {\n        this.isPlay = false;\n        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(\".home-view\", (0, skynode_1.el)(\".video-container\", this.video = (0, skynode_1.el)(\"video\", { \"autoplay\": \"\", \"loop\": \"\", \"muted\": \"\" }, (0, skynode_1.el)(\"source\", { src: \"/video/home.mp4\", type: \"video/mp4\" }))), (0, skynode_1.el)(\".audio-container\", {\n            click: () => {\n                if (this.isPlay) {\n                    this.audio.domElement.pause();\n                    this.isPlay = false;\n                }\n                this.audio.domElement.play();\n                this.isPlay = true;\n                this.playButton.addClass(\"playing\");\n            }\n        }, this.playButton = (0, skynode_1.el)(\".play-button\"), this.audio = (0, skynode_1.el)(\"audio\", { \"controls\": \"\" }, (0, skynode_1.el)(\"source\", { src: \"/video/bgm.mp3\", type: \"audio/mp3\" })))).appendTo(skynode_1.BodyNode));\n        this.init();\n    }\n    init() {\n        this.video.domElement.muted = true;\n    }\n    changeParams(params, uri) { }\n    close() {\n        this.container.delete();\n    }\n}\nexports[\"default\"] = Home;\n\n\n//# sourceURL=webpack:///./src/view/Home.ts?");
...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst skynode_1 = __webpack_require__(/*! @hanul/skynode */ \"./node_modules/@hanul/skynode/lib/index.js\");\nconst Layout_1 = __importDefault(__webpack_require__(/*! ./Layout */ \"./src/view/Layout.ts\"));\nclass Update {\n    constructor() {\n        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(\".update-view\").appendTo(skynode_1.BodyNode));\n    }\n    changeParams(params, uri) { }\n    close() {\n        this.container.delete();\n    }\n}\nexports[\"default\"] = Update;\n\n\n//# sourceURL=webpack:///./src/view/Update.ts?");
